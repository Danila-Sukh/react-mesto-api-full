...
function App() {
  ...
  const [infoTooltipText, setIsInfoTooltipText] = React.useState(
  ...
  //загрузка информации после авторизации
  function allDataGet(jwt) {
    api
      .getAppInfo(jwt)
